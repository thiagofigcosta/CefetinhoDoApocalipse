...
//erase v
void eraseMe(){
cout<<"abs,-abs: ("<<ABS(25.5)<<","<<ABS(-65.323)<<")\n";
vector<string> tmp;
vector<int> tmp2;
...
int main(int argc, char** argv) {
    ...
    if(!loadMaps(1)) if(Util::DEBUG) cout<<"erro ao carregar mapas"<<endl;
    ...
    player=new Player(5,2,2,Util::nTPointSet(0,0,0),Util::nTPointSet(30,60,0),Entity::getAnimationVector(playerAnim[0],playerAnimSize[0]),1);
