...
void mapEdit::drawPanel(){
    ...
    GL::buttonBehave(Util::nTRectangleSet(470+Scenes::camera.x.movedCam,570+Scenes::camera.y.movedCam,500+Scenes::camera.x.movedCam,533+Scenes::camera.y.movedCam,1,1),GL::getColorByName("mouseSelected"),GL::getTextureByName("Back"),*mapEditLeave,NULL,NULL,NULL);
    ...
    GL::drawText(Util::nTPointSet(550+Scenes::camera.x.movedCam,582+Scenes::camera.y.movedCam,1),(char*)Blocks::getTexNameByIndex(currentBlock).c_str(),GL::getColorByName("black"));
