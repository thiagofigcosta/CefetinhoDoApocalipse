...
void mapEdit::definePages(){
   ...
   for(int i=351;i<357;i++)
    ...
    rowTmp.push_back(376);
    rowTmp.push_back(378);
    rowTmp.push_back(377);
...
void mapEdit::drawPanel(){
    ...
    GL::drawText(Util::nTPointSet(500+Scenes::camera.x.movedCam,582+Scenes::camera.y.movedCam,1),(char*)Blocks::getTexNameByIndex(currentBlock).c_str(),GL::getColorByName("black"));
