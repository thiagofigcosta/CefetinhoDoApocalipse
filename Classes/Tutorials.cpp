...
//string declarations:
  ...
  string Tutorials::jumpHelp="Voce pode atacar em qualquer direcao enquanto     estiver no ar , para pular pressione [ ESPACO ] ;";
  ...
  if(showTutorials){
    if(isCalled){
      if(pressedKey!=key){
        ...
        Scenes::camera.y.movedCam,
        800+Scenes::camera.x.movedCam,
        300+Scenes::camera.y.movedCam,0.9,0.9)),
