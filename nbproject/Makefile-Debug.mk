...
${OBJECTDIR}/Classes/Bullet.o: Classes/Bullet.cpp 
	${MKDIR} -p ${OBJECTDIR}/Classes
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/Bullet.o Classes/Bullet.cpp
...
${OBJECTDIR}/Classes/Scenes.o: Classes/Scenes.cpp 
	${MKDIR} -p ${OBJECTDIR}/Classes
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/Scenes.o Classes/Scenes.cpp

${OBJECTDIR}/Classes/Tutorials.o: Classes/Tutorials.cpp 
	${MKDIR} -p ${OBJECTDIR}/Classes
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/Tutorials.o Classes/Tutorials.cpp
...
${OBJECTDIR}/Classes/mapEdit.o: Classes/mapEdit.cpp 
	${MKDIR} -p ${OBJECTDIR}/Classes
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/mapEdit.o Classes/mapEdit.cpp

${OBJECTDIR}/Classes/powerUp.o: Classes/powerUp.cpp 
	${MKDIR} -p ${OBJECTDIR}/Classes
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/powerUp.o Classes/powerUp.cpp
...
${OBJECTDIR}/Libs/Globals.o: Libs/Globals.cpp 
	${MKDIR} -p ${OBJECTDIR}/Libs
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Libs/Globals.o Libs/Globals.cpp
