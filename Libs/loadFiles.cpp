...
bool loadMaps(){
    //TODO:carregar mapas. retorna falso se nao carregou algum arquivo
    //carregar numero de linhas,numero de colunas,id de background e depois a matriz
}
bool saveMaps(){
    //TODO:salvar mapas. retorna falso se nao carregou algum arquivo
    //salvar numero de linhas,numero de colunas,id de background e depois a matriz
}
bool loadSounds(){
