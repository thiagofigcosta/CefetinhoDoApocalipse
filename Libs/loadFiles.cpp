...
bool loadTextures(){
    ...
    if(!GL::loadTexture("Tijolo areia ","Textures/blocks/189.png"))out=false;
      ...
      //ground
        ...
        //graduacao
          //atack
            //melee
              //air
                if((GL::loadTextures("graduacaoAtkMeleeAirDown",1,"Textures/characters/cefetinho/atack/melee/air/down/")).size()!=1)out=false;
                if((GL::loadTextures("graduacaoAtkMeleeAirFront",1,"Textures/characters/cefetinho/atack/melee/air/front/")).size()!=1)out=false;
                if((GL::loadTextures("graduacaoAtkMeleeAirUp",1,"Textures/characters/cefetinho/atack/melee/air/up/")).size()!=1)out=false;
              //ground
                if((GL::loadTextures("graduacaoAtkMeleeGroundFront",1,"Textures/characters/cefetinho/atack/melee/ground/front/")).size()!=1)out=false;
                if((GL::loadTextures("graduacaoAtkMeleeGroundUp",1,"Textures/characters/cefetinho/atack/melee/ground/up/")).size()!=1)out=false;
            //ranged
              //air
                if((GL::loadTextures("graduacaoAtkRangedAirDown",1,"Textures/characters/cefetinho/atack/ranged/air/down/")).size()!=1)out=false;
                if((GL::loadTextures("graduacaoAtkRangedAirFront",1,"Textures/characters/cefetinho/atack/ranged/air/front/")).size()!=1)out=false;
                if((GL::loadTextures("graduacaoAtkRangedAirUp",1,"Textures/characters/cefetinho/atack/ranged/air/up/")).size()!=1)out=false;
              //ground
                if((GL::loadTextures("posgradAtkRangedGroundFront",4,"Textures/characters/cefetinho/atack/ranged/ground/front/")).size()!=4)out=false;
                if((GL::loadTextures("posgradAtkRangedGroundUp",1,"Textures/characters/cefetinho/atack/ranged/ground/up/")).size()!=1)out=false;
          //damage
            if((GL::loadTextures("graduacaoDmgAir",1,"Textures/characters/cefetinho/damage/air/")).size()!=1)out=false;
            if((GL::loadTextures("graduacaoDmgGround",1,"Textures/characters/cefetinho/damage/ground/")).size()!=1)out=false;
          if((GL::loadTextures("graduacaoDie",4,"Textures/characters/cefetinho/die")).size()!=4)out=false;
          if((GL::loadTextures("graduacaoIdle",5,"Textures/characters/cefetinho/idle")).size()!=5)out=false;
          if((GL::loadTextures("graduacaoJump",1,"Textures/characters/cefetinho/jump")).size()!=1)out=false;
          //move
            if((GL::loadTextures("graduacaoMoveRun",4,"Textures/characters/cefetinho/move/run")).size()!=4)out=false;
            if((GL::loadTextures("graduacaoMoveWalk",4,"Textures/characters/cefetinho/move/walk")).size()!=4)out=false;
          if((GL::loadTextures("graduacaoSpawn",7,"Textures/characters/cefetinho/spawn")).size()!=7)out=false;
        //posgrad
        //atack
          //melee
            //air
              if((GL::loadTextures("posgradAtkMeleeAirDown",1,"Textures/characters/cefetinho/atack/melee/air/down/")).size()!=1)out=false;
              if((GL::loadTextures("posgradAtkMeleeAirFront",1,"Textures/characters/cefetinho/atack/melee/air/front/")).size()!=1)out=false;
              if((GL::loadTextures("posgradAtkMeleeAirUp",1,"Textures/characters/cefetinho/atack/melee/air/up/")).size()!=1)out=false;
            //ground
              if((GL::loadTextures("posgradAtkMeleeGroundFront",1,"Textures/characters/cefetinho/atack/melee/ground/front/")).size()!=1)out=false;
              if((GL::loadTextures("posgradAtkMeleeGroundUp",1,"Textures/characters/cefetinho/atack/melee/ground/up/")).size()!=1)out=false;
          //ranged
            //air
              if((GL::loadTextures("posgradAtkRangedAirDown",1,"Textures/characters/cefetinho/atack/ranged/air/down/")).size()!=1)out=false;
              if((GL::loadTextures("posgradAtkRangedAirFront",1,"Textures/characters/cefetinho/atack/ranged/air/front/")).size()!=1)out=false;
              if((GL::loadTextures("posgradAtkRangedAirUp",1,"Textures/characters/cefetinho/atack/ranged/air/up/")).size()!=1)out=false;
            //ground
              if((GL::loadTextures("posgradAtkRangedGroundFront",4,"Textures/characters/cefetinho/atack/ranged/ground/front/")).size()!=4)out=false;
              if((GL::loadTextures("posgradAtkRangedGroundUp",1,"Textures/characters/cefetinho/atack/ranged/ground/up/")).size()!=1)out=false;
        //damage
          if((GL::loadTextures("posgradDmgAir",1,"Textures/characters/cefetinho/damage/air/")).size()!=1)out=false;
          if((GL::loadTextures("posgradDmgGround",1,"Textures/characters/cefetinho/damage/ground/")).size()!=1)out=false;
        if((GL::loadTextures("posgradDie",4,"Textures/characters/cefetinho/die")).size()!=4)out=false;
        if((GL::loadTextures("posgradIdle",5,"Textures/characters/cefetinho/idle")).size()!=5)out=false;
        if((GL::loadTextures("posgradJump",1,"Textures/characters/cefetinho/jump")).size()!=1)out=false;
        //move
          if((GL::loadTextures("posgradMoveRun",4,"Textures/characters/cefetinho/move/run")).size()!=4)out=false;
          if((GL::loadTextures("posgradMoveWalk",4,"Textures/characters/cefetinho/move/walk")).size()!=4)out=false;
        if((GL::loadTextures("posgradSpawn",7,"Textures/characters/cefetinho/spawn")).size()!=7)out=false;
    return out;
}
bool loadStrings(){
